...
In comparsion to June.2017 the other notable change is that the acute cases are being performed at the end of the day as opposed to the beginning;
...
##Summary
The results from June describe how most acute cases are done in the acute theatre. The short duration cases are done at night, whilst the longer duration acute cases are done during working hours. The ration of acute cases undertaken during the day compared to after hours is 2:1. By specialty General Surgery is the most prevalent followed by orthopedic surgery and the O&G.Cases build by over the week, making Friday the most common day for acute cases to occur, with this build up being most marked in General Surgery. 

In contrast November 2017  reveals a number of changes. There has been a significant increase in the mean duration of after hours acute cases. This change can be solely explained by the non-significant reduction in acute case provision by O&G. A more likely explanation is it reflects a change in anesthetic practice, so only more time dependent in critical cases occur after hours, as reflected by the significant increase in duration.

Otherwise little has changed between June and November in the pattern of acute care provision as seen through the lens of the OTIS data set.